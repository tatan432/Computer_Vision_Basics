function [H_final,out_img] = get_ransac_homography(img1_name,img2_name)


%%% Command to Run the Program :
%%% [H12,~]=get_ransac_homography("im01.jpg","im02.jpg")
%%% [H21,~]=get_ransac_homography("im02.jpg","im01.jpg")
%%% Read Two Imgaes
...
for T=1:iterations
    ...
    %H_match = [0.00273541535771803,-0.000657538117581661,0.0852590070205328;8.51727573393095e-05,0.00156852187564466,0.996347973230951;-9.24744842410913e-08,-2.52542125219823e-06,0.00335195245113636];
%   H Matrix to Match from im01 to im02
%     0.0027    0.0008   -0.2886
%    -0.0001    0.0032   -0.9574
%    -0.0000    0.0000    0.0015
%   H Matrix to Match from im02 to im01
%   -0.0028    0.0008   -0.0690
%    -0.0001   -0.0014   -0.9976
